...
const CheckoutPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex justify-center">
            ...
            <div className="w-full max-w-[480px] min-h-screen bg-gray-50 shadow-2xl relative pb-24">
                {/* Header */}
                            ...
                            <div className="flex items-center justify-between text-sm text-gray-600">
                                ...
                                {checkoutStep === 2 && (
                                    <button
                                        ...
                                        className="text-primary-600 text-xs font-semibold active:text-primary-700"
                                    >
                                        ← К блюдам
                                    </button>
                                )}
